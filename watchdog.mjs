...
function createAttemptScope() {
  ...
  if (Number(statfsSync(scopePath).type) !== 0x63677270) throw new Error("attempt scope is not cgroup-v2");
  requireControlFiles();
...
function trace(_event) {}
function injectFailure(_phase) {}
async function pauseAt(_phase) {}
